import { ReactFlow, Controls, Background, BackgroundVariant, addEdge, useNodesState, useEdgesState, Connection, Edge, NodeTypes, MarkerType, Node, ConnectionMode } from '@xyflow/react';
...
const initialEdges: any[] = [
  ...
  { 
    ...
    markerEnd: { type: MarkerType.ArrowClosed, color: 'var(--vscode-editorLineNumber-foreground, #cbd5e1)' }
  }
];
...
function App() {
  ...
  const onConnect = useCallback((params: Connection | Edge) => setEdges((eds) => addEdge({
    ...params,
    type: 'customCurve',
    markerEnd: { type: MarkerType.ArrowClosed, color: 'var(--vscode-editorLineNumber-foreground, #cbd5e1)' },
    style: { strokeWidth: 2 }
